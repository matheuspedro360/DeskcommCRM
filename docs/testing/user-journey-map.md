...
| J4.43 | **Alcançar as últimas etapas de um funil largo** | em janela estreita, a barra acima dos cards fica visível; teclado até o fim desloca o quadro até a última etapa, e rolar o quadro atualiza a barra. `tests/e2e/kanban-owner-filter.spec.ts`. **Teste escrito, ainda sem execução em ambiente E2E com login e banco local.** |
